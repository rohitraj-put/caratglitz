  ...
  useEffect(() => {
    if (consentAccepted) {
      ...
      localStorage.setItem(
        "analytics",
        JSON.stringify(cookiePreferences.analytics)
      );
      localStorage.setItem(
        "marketing",
        JSON.stringify(cookiePreferences.marketing)
      );
      localStorage.setItem(
        "preferences",
        JSON.stringify(cookiePreferences.preferences)
      );
      loadCookies();
    }
