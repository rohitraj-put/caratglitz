                        ...
                        <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                            ...
                            <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                                <form className="w-full">
                                    ...
                                    <div
                                        className=" border-gray-100 p-2 sm:flex sm:justify-end sm:gap-4"
                                    >
                                        <input
                                            type="email"
                                            id="UserEmail"
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> Reach Us </a>
                                    </li>

                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75">Returns </a>
                                    </li>

                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> Shiping Policy </a>
                                    </li>
                                    <li>
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> My Account </a>
                                    </li>

                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> Orders History </a>
                                    </li>

                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75">Wishlist </a>
                                    </li>
                                </ul>
                            </div>
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75">Level 10, 18-20
                                            Hindustan Times House
                                            KG Marg, Connaught Place
                                            New Delhi, India -110001</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> Suite No. 01
                                            Abrak Business Center
                                            Business Bay Dubai, U.A.E. </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> 14 San Sebastian Tower
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> 71-75 Shelton Street
                                            Covent Garden
                                            London, WC2H 9JQ</a>
                                    </li>
                                </ul>
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li className=''>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> 54 State Street
                                            Ste 804 Albany
                                            NY -12207 U.S.A.</a>
                                    </li>
                                </ul>
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li className=''>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75">+91 98992 10105</a>
                                    </li>
                                    <li className=''>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75">info@caratglitz.com</a>
                                    </li>
                                </ul>
                            </div>
